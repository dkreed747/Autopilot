#ifndef APPS_AUTOPILOT_TOOLS_OPERATIONALMODECLIENT_HPP_
#define APPS_AUTOPILOT_TOOLS_OPERATIONALMODECLIENT_HPP_
...
#endif  // APPS_AUTOPILOT_TOOLS_OPERATIONALMODECLIENT_HPP_
