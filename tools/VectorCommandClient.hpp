#ifndef APPS_AUTOPILOT_TOOLS_VECTORCOMMANDCLIENT_HPP_
#define APPS_AUTOPILOT_TOOLS_VECTORCOMMANDCLIENT_HPP_
...
#endif  // APPS_AUTOPILOT_TOOLS_VECTORCOMMANDCLIENT_HPP_
