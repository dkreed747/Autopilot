...
class ConstraintsClient {
 public:
  ...
  ConstraintsClient(const dds::domain::DomainParticipant& participant, const dds::pub::qos::DataWriterQos& wqos,
                    const dds::sub::qos::DataReaderQos& rqos, const dds::sub::qos::DataReaderQos& largeSetRqos,
  ...
  std::string upsertZone(const std::string& id, const std::string& name, bool keepIn,
                         ...
                         const std::string& ceilingFrame, flt64_t floorM, const std::string& floorFrame);

  //! \brief Create or update a speed constraint ("lte" = max speed, "gte" = min speed).
  std::string upsertSpeed(const std::string& id, const std::string& name, const std::string& op, flt64_t valueMps);

  //! \brief Create or update a depth constraint ("lte" = max depth, "gte" = min depth).
  std::string upsertDepth(const std::string& id, const std::string& name, const std::string& op, flt64_t valueM);
 ...
 private:
  ...
  void sendAdd(const arlcore::NumericGuid& conditionalId, const std::string& name, const std::string& topic,
               const arlcore::NumericGuid& specId, const UMAA::Common::Measurement::DateTime& stamp);
  ...
  std::shared_ptr<arlcore::io::CycloneSender<UMAA::MM::ConditionalControl::ConditionalDeleteCommandType>> deleteSender_;
  ...
  std::shared_ptr<arlcore::io::CycloneReader<UMAA::MM::ActiveConstraintsControl::ActiveConstraintsCommandAckReportType>>
      ackReader_;
  std::shared_ptr<arlcore::io::CycloneReader<UMAA::MM::ConditionalControl::ConditionalAddCommandStatusType>>
      addStatusReader_;
  std::shared_ptr<arlcore::io::CycloneReader<UMAA::MM::ConditionalControl::ConditionalDeleteCommandStatusType>>
      deleteStatusReader_;
  std::shared_ptr<arlcore::io::CycloneReader<UMAA::MM::ActiveConstraintsControl::ActiveConstraintsCommandStatusType>>
      activeStatusReader_;
  std::shared_ptr<arlcore::io::CycloneReader<UMAA::MM::ConditionalStateReport::ConditionalStateReportType>>
      stateReader_;
