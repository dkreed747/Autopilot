#ifndef AUTOPILOT_TOOLS_MONITORS_VECTORACTIVITYMONITOR_HPP_
#define AUTOPILOT_TOOLS_MONITORS_VECTORACTIVITYMONITOR_HPP_
...
#endif  // AUTOPILOT_TOOLS_MONITORS_VECTORACTIVITYMONITOR_HPP_
