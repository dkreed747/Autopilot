#ifndef APPS_AUTOPILOT_INCLUDE_AUTOPILOT_VECTORZONEGUIDANCE_H_
#define APPS_AUTOPILOT_INCLUDE_AUTOPILOT_VECTORZONEGUIDANCE_H_
...
#endif  // APPS_AUTOPILOT_INCLUDE_AUTOPILOT_VECTORZONEGUIDANCE_H_
